...
from .models import Aluno, Curso, Materia, MateriaDoCurso, Matricula, Prova, Material, Questao, ProvaRealizadaPeloAluno, QuestaoDaProvaRealizadaPeloAluno, BoletimDeDesempenhoDoAluno, Parcela
